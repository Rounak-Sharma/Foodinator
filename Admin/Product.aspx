<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Foodienator.Admin.Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pcoded-inner-content pt-0">
        <div class="align-baseline align-self-end">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4 sol-lg-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                                            ErrorMessage="Price should be in decimal" ValidationExpression="^\d{0,8}(\.\d{1,4})?$" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                            ErrorMessage="Quantity Must be non-negative" ValidationExpression="^([1-9]\d*|0)$"
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:DropDownList ID="ddlCategories" runat="server" CssClass ="form-control" 
                                                            ...
                                                            <asp:ListItem Valu="0">Select Category</asp:ListItem>
                                                        </asp:DropDownList> 
