<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Foodienator.User.Cart" %>
            ...
            <asp:Repeater ID ="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lblDelete" runat="server" Text ="Remove" CommandName="remove" 
                                ...
                                OnClientClick="return confirm('Do you want to remove the item from the cart?')">
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lblCheckout" runat="server" CommandName="checkout" CssClass="btn btn-sucess">
